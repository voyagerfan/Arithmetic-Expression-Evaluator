...
{
	/**
	 * This method evaluates a postfix string and returns a numerical
	 * result. The for loop iterates through each char of the postfix
	 * string converting valid chars to integers and leveraging a
	 * stack to perform cumulative calculations.
	 *
